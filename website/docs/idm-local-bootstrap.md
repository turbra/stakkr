...
- `freeipa.ansible_freeipa` installed from
  [requirements.yml](https://github.com/turbra/stakkr/blob/main/requirements.yml)
- a local vaulted
...
- [idm_vm.yml](https://github.com/turbra/stakkr/blob/main/vars/guests/idm_vm.yml)
