...
- Default host CPU policy findings:
  <a href="{{ '/shared-execution-pool-validation.html' | relative_url }}">Shared Execution Pool Validation</a>
...
- Experimental clock-policy findings:
  <a href="{{ '/clock-frequency-validation.html' | relative_url }}">Clock Frequency Tiering Validation</a>
